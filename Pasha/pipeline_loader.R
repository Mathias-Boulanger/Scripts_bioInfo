...
paramsDefinition[["--resultSubFolder"]]=list(variableName="resultSubFolder", numeric=F, mandatory=F, description="Subfolders containing results in the experiment folder", default="ResultPipeline");
paramsDefinition[["--reportFilesSubFolder"]]=list(variableName="reportFilesSubFolder", numeric=F, mandatory=F, description="Subfolder containing Logs in the Result folder", default="Logs");
...
paramsDefinition[["--CPU"]]=list(variableName="nbCPU", numeric=T, mandatory=F, description="Number of threads to start (AT THE COST OF MEMORY)", default=2);
