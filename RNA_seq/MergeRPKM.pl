...
my $to_remove_from_file_title = "/home/chipseq/Bureau/Formation/Rnaseq/Cufflinks/"; # titre contient 

 
my $to_remove_from_file_title1 = "/genes.fpkm_value"; # titre contient 
my $to_remove_from_file_title2 = "/cufflinks_hg19"; # titre contient  
my $to_remove_from_file_title3 = "/cufflinks_ERCC92"; # titre contient    
