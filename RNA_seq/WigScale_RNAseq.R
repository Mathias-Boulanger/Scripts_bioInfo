##############################################################
# This script is used to Scale Wig files 
##############################################################
...
paramsDefinition[["--subtractInput"]]=list(variableName="subtractInput", numeric=F, mandatory=F, description="Indicates if whether the input must be subtracted from the WIG files or not.", default=FALSE);
